...
void write_dat_from_csv(const std::string& f = "D:/Documentos/Rodrigo/Utec/ciclo 2024-1/BD II/BD2_CLON/src/proxy/data/AppleStore.csv") {
    std::ifstream file(f);
    if (!file) {
    ...
    std::ofstream out_file("D:/Documentos/Rodrigo/Utec/ciclo 2024-1/BD II/BD2_CLON/src/proxy/data/AppleStore.dat", std::ios::binary);
    if (!out_file) {
